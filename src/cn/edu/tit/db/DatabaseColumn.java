...
public abstract class DatabaseColumn implements BaseColumns {
	 ...
	 */
	public static final String AUTHORITY = "cn.edu.tit.db.DBProvider";
	/**
	 * The database's name
	 */
...
//			"com.example.newpage.db.BlogColumn", "com.example.newpage.db.NewsColumn",
//			"com.example.newpage.db.DetailColumn", "com.example.newpage.db.ImageCacheColumn",
//			"com.example.newpage.db.RequestCacheColumn" };
	
	public static final String[] SUBCLASSES = new String[] {
		 "cn.edu.tit.db.ImageCacheColumn"
		 };
