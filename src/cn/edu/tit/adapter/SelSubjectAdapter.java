...
public class SelSubjectAdapter<T> extends BaseAdapter implements Filterable {
...
//	//支持多音字
//	public SelSubjectAdapter(Context context,int textViewResourceId, T[] objects,int maxMatch) {
...
//	}
	...
	public SelSubjectAdapter(Context context,List<T> objects,int maxMatch) {
		// TODO Auto-generated constructor stub
		this.pinyinList = getHanziSpellList(objects);
		this.maxMatch=maxMatch;
